  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 5, md: 8 } }}>
        ...
        >
          Authentic Maharashtrian Home Food — Aamchi Chav
        </Typography>
        <Box
          sx={{ width: 80, height: 4, backgroundColor: "#ff6f00", borderRadius: 2, mx: "auto", mt: 2.5 }}
        />
      </Box>
              ...
              >
                ...
                <Box sx={{ p: 3, display: "flex", flexDirection: "column" }}>
                  ...
                  <Typography sx={{ fontSize: "1rem", color: "#555", lineHeight: 1.7, mb: 2.5 }}>
                    A beloved recipe from our Maharashtrian home kitchen — made fresh daily with regional spices and authentic ingredients. The true taste of Maharashtra, delivered to you. — ₹{dish.price} per plate.
                  </Typography>
      ...
      <Box sx={{ textAlign: "center", mt: { xs: 7, md: 10 } }}>
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": { backgroundColor: "#ff6f00cc", color: "#fff" },
          }}
        >
          Order Maharashtrian Food Now 🌶️
        </Button>
      </Box>
          ...
          <>
            ...
            <DialogContent sx={{ px: 4, pt: 3, pb: 1 }}>
              ...
              <Typography sx={{ fontSize: "0.97rem", color: "#555", lineHeight: 1.8, mb: 3 }}>
                A beloved recipe from our Maharashtrian home kitchen — made fresh daily with regional spices and authentic ingredients. The true taste of Maharashtra, delivered to you. Crafted fresh daily, delivered to your door.
              </Typography>
            ...
            >
              ...
              <Button
                variant="contained"
                onClick={() => {
                  addToCart({ ...selectedDish, cuisine: "Maharashtrian" }, quantity);
                  handleClose();
                  navigate("/cart");
                }}
                sx={{
