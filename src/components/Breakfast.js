...
// Import images
import b1 from './breakfast1.jpg';
import b2 from './breakfast2.jpg';
import b3 from './breakfast3.jpg';
...
const Breakfast = () => {
    ...
    const mealPlans = [
        {
            ...
            title: 'Morning Breakfast - Monthly',
            price: 2200,
            originalPrice: 3000,
            discount: '27% OFF',
            description: '2 Nos. of Any Breakfast Option such as Pohe, Upma, Stuffed Paratha, etc. Fresh and homemade.',
        ...
        {
            id: 'breakfast-biweekly',
            title: 'Morning Breakfast - Biweekly',
            price: 1150,
            originalPrice: 1500,
            discount: '23% OFF',
            description: '2 Nos. of Any Breakfast Option such as Pohe, Upma, Stuffed Paratha, etc. Fresh and homemade.',
        ...
        {
            id: 'breakfast-weekly',
            title: 'Morning Breakfast - Weekly (Trial)',
            price: 600,
            originalPrice: 750,
            discount: '20% OFF',
            description: '2 Nos. of Any Breakfast Option such as Pohe, Upma, Stuffed Paratha, etc. Fresh and homemade.',
    ...
    // Filter backend foods with tag 'breakfast'
    const backendFoods = foodListData?.data?.filter(food => 
        food.tags?.some(tag => tag.toLowerCase().trim() === 'breakfast')
    ).map(food => ({
        id: food._id,
        title: food.foodName,
        price: food.price,
