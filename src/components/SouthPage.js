  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 5, md: 8 } }}>
        ...
        >
          Authentic South Indian Home Food — Rusichi Ruchi
        </Typography>
        <Box
          sx={{ width: 80, height: 4, backgroundColor: "#1b5e20", borderRadius: 2, mx: "auto", mt: 2.5 }}
        />
      </Box>
              ...
              >
                ...
                <Box sx={{ p: 3, display: "flex", flexDirection: "column" }}>
                  ...
                  <Typography sx={{ fontSize: "1rem", color: "#555", lineHeight: 1.7, mb: 2.5 }}>
                    A staple from our South Indian home kitchen — made fresh daily with premium ingredients. Perfect for a wholesome, authentic meal delivered to your door. — ₹{dish.price} per plate.
                  </Typography>
      ...
      <Box sx={{ textAlign: "center", mt: { xs: 7, md: 10 } }}>
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": { backgroundColor: "#1b5e20cc", color: "#fff" },
          }}
        >
          Order South Indian Food Now 🍛
        </Button>
      </Box>
          ...
          <>
            ...
            <DialogContent sx={{ px: 4, pt: 3, pb: 1 }}>
              ...
              <Typography sx={{ fontSize: "0.97rem", color: "#555", lineHeight: 1.8, mb: 3 }}>
                A staple from our South Indian home kitchen — made fresh daily with premium ingredients. Perfect for a wholesome, authentic meal delivered to your door. Crafted fresh daily, delivered to your door.
              </Typography>
            ...
            >
              ...
              <Button
                variant="contained"
                onClick={() => {
                  addToCart({ ...selectedDish, cuisine: "South" }, quantity);
                  handleClose();
                  navigate("/cart");
                }}
                sx={{
