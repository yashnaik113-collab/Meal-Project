...
import classic2 from './classic2.jpg';
import classic3 from './classic3.jpg';
import classic4 from './classic4.jpg';
...
const ClassicThali = () => {
    ...
    const mealPlans = [
        {
            id: 'ct-monthly',
            title: 'Classic Thali - Monthly',
            price: 3000,
            originalPrice: 4000,
            discount: '25% OFF',
            description: '3 Chapati, 1 Veg Curry, Dal, Cut Salad',
        ...
        {
            id: 'ct-weekly',
            title: 'Classic Thali - Weekly (Trial)',
            price: 850,
            originalPrice: 1000,
            discount: '15% OFF',
            description: '3 Chapati, 1 Veg Curry, Dal, Cut Salad',
