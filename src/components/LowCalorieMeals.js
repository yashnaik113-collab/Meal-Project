...
// Import images
import lc1 from './lowcalorie1.jpg';
import lc2 from './lowcalorie2.jpg';
import lc3 from './lowcalorie3.jpg';
...
const LowCalorieMeals = () => {
    ...
    const mealPlans = [
        {
            id: 'lc-weekly',
            title: 'Low Calorie Meals - weekly (5 Days)',
            price: 1550,
            originalPrice: 1750,
            discount: '11% OFF',
            description: 'Scientifically designed Low Calorie Meal Plans to help you stay fit and healthy.',
        ...
        {
            id: 'lc-monthly',
            title: 'Low Calorie Meals - Monthly',
            price: 5800,
            originalPrice: 7000,
            discount: '17% OFF',
            description: 'Scientifically designed Low Calorie Meal Plans to help you stay fit and healthy.',
        ...
        {
            id: 'lc-biweekly',
            title: 'Low Calorie Meals - Biweekly',
            price: 3000,
            originalPrice: 3500,
            discount: '14% OFF',
            description: 'Scientifically designed Low Calorie Meal Plans to help you stay fit and healthy.',
    ...
    // Filter backend foods with tag 'low calorie'
    const backendFoods = foodListData?.data?.filter(food => 
        food.tags?.some(tag => tag.toLowerCase().trim() === 'low calorie')
    ).map(food => ({
        id: food._id,
        title: food.foodName,
        price: food.price,
...
export default LowCalorieMeals;
