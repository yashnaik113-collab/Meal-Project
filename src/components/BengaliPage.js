  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 5, md: 8 } }}>
        ...
        >
          Authentic Bengali Home Food — Amar Sonar Bangla
        </Typography>
        <Box
          sx={{ width: 80, height: 4, backgroundColor: "#006064", borderRadius: 2, mx: "auto", mt: 2.5 }}
        />
      </Box>
              ...
              >
                ...
                <Box sx={{ p: 3, display: "flex", flexDirection: "column" }}>
                  ...
                  <Typography sx={{ fontSize: "1rem", color: "#555", lineHeight: 1.7, mb: 2.5 }}>
                    A beloved recipe from our Bengali home kitchen — made fresh daily with mustard, hilsa, and the warmth of a true Bengali household. Authentic flavors delivered to you. — ₹{dish.price} per plate.
                  </Typography>
      ...
      <Box sx={{ textAlign: "center", mt: { xs: 7, md: 10 } }}>
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": { backgroundColor: "#006064cc", color: "#fff" },
          }}
        >
          Order Bengali Food Now 🐟
        </Button>
      </Box>
          ...
          <>
            ...
            <DialogContent sx={{ px: 4, pt: 3, pb: 1 }}>
              ...
              <Typography sx={{ fontSize: "0.97rem", color: "#555", lineHeight: 1.8, mb: 3 }}>
                A beloved recipe from our Bengali home kitchen — made fresh daily with mustard, hilsa, and the warmth of a true Bengali household. Authentic flavors delivered to you. Crafted fresh daily, delivered to your door.
              </Typography>
            ...
            >
              ...
              <Button
                variant="contained"
                onClick={() => {
                  addToCart({ ...selectedDish, cuisine: "Bengali" }, quantity);
                  handleClose();
                  navigate("/cart");
                }}
                sx={{
