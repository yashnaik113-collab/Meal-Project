...
// Import images
import comfort1 from './comfort1.jpg';
...
const ComfortThali = () => {
    ...
    const mealPlans = [
        {
            id: 'cot-monthly',
            title: 'Comfort Thali - Monthly',
            price: 2700,
            originalPrice: 3800,
            discount: '29% OFF',
            description: '1 Veg Curry, Rice, Dal, Cut Salad',
        ...
        {
            id: 'cot-weekly',
            title: 'Comfort Thali - Weekly (Trial)',
            price: 775,
            originalPrice: 950,
            discount: '18% OFF',
            description: '1 Veg Curry, Rice, Dal, Cut Salad',
    ...
    // Filter backend foods with tag 'comfort thali'
    const backendFoods = foodListData?.data?.filter(food => 
        food.tags?.some(tag => tag.toLowerCase() === 'comfort thali')
    ).map(food => ({
        id: food._id,
        title: food.foodName,
        price: food.price,
