...
// Import images
import corpImg1 from './corporate1.jpg';
import corpImg2 from './corporate2.jpg';
import corpImg3 from './corporate3.jpg';
import corpImg4 from './corporate4.jpg';
import corpImg5 from './corporate5.jpg';
...
const Corporate = () => {
    ...
    // Filter backend foods with tag 'corporate'
    const backendFoods = foodListData?.data?.filter(food => 
        food.tags?.some(tag => tag.toLowerCase().trim() === 'corporate')
    ).map(food => ({
        id: food._id,
        title: food.foodName,
        price: food.price,
    ...
    return (
        <div className="special-thali-page-root">
            ...
            <div className="special-thali-container">
                <div className="section-label">CORPORATE MEALS</div>
