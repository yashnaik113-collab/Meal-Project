  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 5, md: 8 } }}>
        ...
        >
          Authentic Rajasthani Home Food — Mharo Rajasthan
        </Typography>
        <Box
          sx={{ width: 80, height: 4, backgroundColor: "#bf360c", borderRadius: 2, mx: "auto", mt: 2.5 }}
        />
      </Box>
              ...
              >
                ...
                <Box sx={{ p: 3, display: "flex", flexDirection: "column" }}>
                  ...
                  <Typography sx={{ fontSize: "1rem", color: "#555", lineHeight: 1.7, mb: 2.5 }}>
                    A royal recipe from our Rajasthani home kitchen — prepared fresh daily with rich ghee, whole spices, and the majestic flavors of the desert state. Delivered to your doorstep. — ₹{dish.price} per plate.
                  </Typography>
      ...
      <Box sx={{ textAlign: "center", mt: { xs: 7, md: 10 } }}>
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": { backgroundColor: "#bf360ccc", color: "#fff" },
          }}
        >
          Order Rajasthani Food Now 🏜️
        </Button>
      </Box>
          ...
          <>
            ...
            <DialogContent sx={{ px: 4, pt: 3, pb: 1 }}>
              ...
              <Typography sx={{ fontSize: "0.97rem", color: "#555", lineHeight: 1.8, mb: 3 }}>
                A royal recipe from our Rajasthani home kitchen — prepared fresh daily with rich ghee, whole spices, and the majestic flavors of the desert state. Delivered to your doorstep. Crafted fresh daily, delivered to your door.
              </Typography>
            ...
            >
              ...
              <Button
                variant="contained"
                onClick={() => {
                  addToCart({ ...selectedDish, cuisine: "Rajasthani" }, quantity);
                  handleClose();
                  navigate("/cart");
                }}
                sx={{
