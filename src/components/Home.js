...
//             gap: 4,
//             width: "100%",
//             maxWidth: 900, // keeps content centered & not full-width
//           }}
//         >
//           {/* Left: text */}
//           <Box sx={{ flex: 1 }}>
...
import { useGetfoodListData } from "../services/fetchProduct";
import joinCustomer from "../components/joincustomerbg.png";
import joinChef from "../components/joinchefbg_final.png";
      ...
      <Box sx={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <Box sx={{ width: "100%", maxWidth: 900 }}>
            ...
            <Button
              ...
              variant="contained"
              color="warning"
              sx={{ mt: 4, fontSize: "1rem", px: 4, py: 1.2 }}
            >
              Order Now
            </Button>
          </Box>
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={{ textAlign: "center", px: 2 }}>
                ...
                >
                  Home-made food served from nearby family kitchens. We do not
                  partner with restaurants or dhabas — only authentic
                  home-cooked meals.
                </Typography>
              </Box>
            </Grid>
        ...
        <Box sx={{ py: { xs: 6, md: 8 }, px: { xs: 2, md: 8 } }}>
          ...
          >
            ...
            >
              <Typography variant="overline" sx={{ color: "#f0f0f0" }}>
                Homemade food
              </Typography>
              <Typography
                variant="h5"
                sx={{ fontWeight: 800, color: "#4caf50", mt: 0.5, mb: 1 }}
              >
                JOIN AS A CUSTOMER
              </Typography>
              <Typography
          ...
          {/* ── JOIN AS A HOME CHEF: text left | pic right ── */}
          <Box
            sx={{
              display: "flex",
