  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 5, md: 8 } }}>
        ...
        >
          Authentic North Eastern Home Food — From the 7 Sisters
        </Typography>
        <Box
          sx={{ width: 80, height: 4, backgroundColor: "#1a237e", borderRadius: 2, mx: "auto", mt: 2.5 }}
        />
      </Box>
              ...
              >
                ...
                <Box sx={{ p: 3, display: "flex", flexDirection: "column" }}>
                  ...
                  <Typography sx={{ fontSize: "1rem", color: "#555", lineHeight: 1.7, mb: 2.5 }}>
                    A unique recipe from our North Eastern home kitchen — made fresh with indigenous herbs, bamboo, and exotic flavors that tell the story of the 7 Sisters. Delivered hot to you. — ₹{dish.price} per plate.
                  </Typography>
      ...
      <Box sx={{ textAlign: "center", mt: { xs: 7, md: 10 } }}>
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": { backgroundColor: "#1a237ecc", color: "#fff" },
          }}
        >
          Order North Eastern Food Now 🍜
        </Button>
      </Box>
          ...
          <>
            ...
            <DialogContent sx={{ px: 4, pt: 3, pb: 1 }}>
              ...
              <Typography sx={{ fontSize: "0.97rem", color: "#555", lineHeight: 1.8, mb: 3 }}>
                A unique recipe from our North Eastern home kitchen — made fresh with indigenous herbs, bamboo, and exotic flavors that tell the story of the 7 Sisters. Delivered hot to you. Crafted fresh daily, delivered to your door.
              </Typography>
            ...
            >
              ...
              <Button
                variant="contained"
                onClick={() => {
                  addToCart({ ...selectedDish, cuisine: "North" }, quantity);
                  handleClose();
                  navigate("/cart");
                }}
                sx={{
